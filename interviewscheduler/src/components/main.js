...
const Main = () => {
    ...
    return (
       ...
       <TextField id="standard-basic" label="Select Participants" select variant="standard" sx={{ m: 1, width: '20rem' }} value={selected}  onChange={(e)=> {setselected(e.target.value)}}>
        {participants.map(e => (
       ...
       <Button variant="contained" size='small' style={{backgroundColor:'black'}} onClick={handleclick}>Schedule</Button>
       </div>
    )
}
export default Main;